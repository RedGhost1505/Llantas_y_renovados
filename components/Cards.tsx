        ...
        <div className="min-h-screen">
            <div className="container mx-auto px-4 py-8">
                <div className='text-center mb-8'>
                    <p className='text-2xl font-bold text-[#B7B6B6]'>Selecciona una de nuestras llantas</p>
                </div>
                                ...
                                <div className='mt-4 flex flex-row justify-between items-center'>
                                    ...
                                    {selectedItems[tire.codigo] ? (
                                        <div className="flex flex-col items-center">
                                            ...
                                            <button className="mt-4 font-bold bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 transition duration-300">
                                                Ordenar
                                            </button>
                                        </div>
                                    ) : (
